...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('product_name_in_inglish', 'product_name_in_arabic', 'slug', 'price', 'is_available', 'category__category_name_inenglish', "created_date")
    prepopulated_fields = {'slug': ('product_name_in_inglish',)}
    search_fields = ('product_name_in_inglish', 'product_name_in_arabic', 'slug', 'price', 'is_available', 'category__category_name_inenglish', "created_date")
